...
while stream.is_active():
    ...
    if num_frames >= FRAMES_PER_FFT:
        print(note_name(n0)[:5])
        if note_name(n0)[:5] == 'E4.33':
            pag.press('y')
        elif note_name(n0)[:5] == 'A4.75':
            pag.press('w')
        elif note_name(n0)[:5] == 'D4.16':
            pag.press('e')
        elif note_name(n0)[:5] == 'G4.58':
            pag.press('r')
        elif note_name(n0)[:5] == 'B3.91':
            pag.press('space')
        elif note_name(n0)[:5] == 'C4.0':
            pag.press('p')
        elif note_name(n0)[:5] == 'F4.41':
            pag.press('0')
        elif note_name(n0)[:5] == 'D#4.2':
            pag.press('s')
        elif note_name(n0)[:5] == 'C#4.0':
            pag.press('t')
